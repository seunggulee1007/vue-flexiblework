<template>
    <v-row justify="center">
        <v-dialog v-model="isUserDialog" persistent max-width="600px">
            <v-card>
                ...
                <v-card-actions>
                    <v-spacer></v-spacer>
                    <v-btn color="blue darken-1" text @click="toggleUserDialogFlag"> Close </v-btn>
                    <v-btn color="blue darken-1" text @click="toggleUserDialogFlag"> Save </v-btn>
                </v-card-actions>
            </v-card>
        </v-dialog>
    </v-row>
...
export default {
    ...
    methods: {
        ...mapMutations(['toggleUserDialogFlag']),
